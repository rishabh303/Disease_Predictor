...
seq_path = '/home/rishabh/Desktop/diagnosis/Data/patient_sequences/'
balanced_seq_path = '/home/rishabh/Desktop/diagnosis/Data/mimic_balanced/'
num_pred_diag = 80
...
try:
        conn = psycopg2.connect("dbname='mimic' user='mimicuser' host='localhost' password='12345'")
except:
