...
for c, d in enumerate(uniq_diag):
    ...
    with tf.Graph().as_default():
        ...
        joblib.dump(sc, '/home/rishabh/Envs/tf/lib/python3.6/site-packages/tensorflow/python/saved_model/standard.pkl'.format(n_epoch))
        ...
        model = tflearn.DNN(regression, tensorboard_verbose=3,
                            tensorboard_dir='/home/rishabh/Envs/tf/lib/python3.6/site-packages/tensorflow/python/saved_model/Fully_Connected_n_epochs_{}/'.format(d))
        ...
        model.save('/home/rishabh/Envs/tf/lib/python3.6/site-packages/tensorflow/python/saved_model/Fully_Connected_n_epochs_{0}/dense_fully_connected_dropout_5645_{1}.tfl'
                   .format(n_epoch, d))
