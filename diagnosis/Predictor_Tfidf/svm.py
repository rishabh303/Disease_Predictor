...
for c, d in enumerate(uniq_diag):
    ...
    joblib.dump(sc, '/home/rishabh/Envs/tf/lib/python3.6/site-packages/tensorflow/python/saved_model/standard.pkl')
    ...
    joblib.dump(svm, '/home/rishabh/Envs/tf/lib/python3.6/site-packages/tensorflow/python/saved_model/svm_k_{0}_g_{1}_C_{2}_{3}.pkl'.format(kernel, gamma, C, d))
